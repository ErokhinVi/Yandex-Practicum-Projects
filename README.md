...
(https://github.com/ErokhinVi/Yandex-Practicum-Projects/tree/main/credits) | Проанализировать статистику о платёжеспособности клиентов кредитного отдела банка. | `pandas` |
